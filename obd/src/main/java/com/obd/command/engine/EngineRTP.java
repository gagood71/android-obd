...
public class EngineRTP extends Command<RelativeThrottlePositionCommand> {
    ...
    @Override
    protected RelativeThrottlePositionCommand getCommand() {
        return new RelativeThrottlePositionCommand();
    }
